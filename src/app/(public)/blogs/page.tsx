            ...
            <SkeletonTheme baseColor='var(--bg-color)' highlightColor='var(--tertiary-color)'>
                <main className={style.blogs}>
                    ...
                    <Swiper
                        ...
                        modules={[Navigation]}
                    >
                        {trendingBlogs.map((element, index) => (
                            <SwiperSlide key={index} id={index} className={style.card}>
                                {element ? (
                                ...
                                <p className={style.desc}>{element?.excerpt || <Skeleton count={3} />}</p>
                                {element ? (
                    ...
                    <div className={style.popularBlogs}>
                        <BlogCard blogs={popularBlogs} type={"popular"} />
                    </div>

...
const DB_URL =
  "https://growitrapid-04-default-rtdb.asia-southeast1.firebasedatabase.app";
...
export default function Form(props: Props) {
  ...
  function submit(e: any) {
    ...
    try {
      ...
      fetch(
        `${DB_URL}/services/${props.category}/${props.service}/enrollments.json`,
        {
          method: "POST",
    ...
    <div>
      <div>
        ...
        {isSubmitted ? (
          ...
          <>
            <p className={`text-[var(--text-color)] mt-2 mb-4`}>
              Fill the form below to enroll for this service.
            </p>
